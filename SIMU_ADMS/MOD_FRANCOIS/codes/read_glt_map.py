...
filepath = r'C:\Users\service.si\OneDrive - MADININAIR\Documents\Simu_ADMS\MOD_FRANCOIS\test_2_Le_francois_fregate.glt'
...
distance_seuil = 50  # en unités de Web Mercator (mètres)
...
plt.savefig('carte_H2S.png', dpi=300, bbox_inches='tight', transparent=True)
