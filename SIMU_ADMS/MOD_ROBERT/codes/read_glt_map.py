...
ax.set_xlim(gdf.geometry.x.min() - 350, gdf.geometry.x.max() )
ax.set_ylim(gdf.geometry.y.min() -50, gdf.geometry.y.max())
...
plt.savefig('carte_H2S_court_robert.png', dpi=600, bbox_inches='tight', transparent=True)
